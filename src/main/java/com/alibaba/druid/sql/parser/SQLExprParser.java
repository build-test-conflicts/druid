...
if ("long".equalsIgnoreCase(typeName) && lexer.identifierEquals("byte") && JdbcConstants.MYSQL.equals(getDbType())) {
typeName+=(' ' + lexer.stringVal());
lexer.nextToken();
}
 else if ("double".equalsIgnoreCase(typeName) && JdbcConstants.POSTGRESQL.equals(getDbType())) {
typeName+=(' ' + lexer.stringVal());
lexer.nextToken();
}
