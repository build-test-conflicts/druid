...
public abstract class DruidAbstractDataSource extends WrapperAdapter implements DruidAbstractDataSourceMBean, DataSource, DataSourceProxy, Serializable {
  ...
  private static Log LOG=LogFactory.getLog(DruidAbstractDataSource.class);
  public static int DEFAULT_INITIAL_SIZE=0;
  public static int DEFAULT_MAX_ACTIVE_SIZE=8;
  public static int DEFAULT_MAX_IDLE=8;
  public static int DEFAULT_MIN_IDLE=0;
  public static int DEFAULT_MAX_WAIT=-1;
  public static String DEFAULT_VALIDATION_QUERY=null;
  public static boolean DEFAULT_TEST_ON_BORROW=false;
  public static boolean DEFAULT_TEST_ON_RETURN=false;
  public static boolean DEFAULT_WHILE_IDLE=true;
  public static long DEFAULT_TIME_BETWEEN_EVICTION_RUNS_MILLIS=60 * 1000L;
  public static long DEFAULT_TIME_BETWEEN_CONNECT_ERROR_MILLIS=500;
  public static int DEFAULT_NUM_TESTS_PER_EVICTION_RUN=3;
  public static long DEFAULT_MIN_EVICTABLE_IDLE_TIME_MILLIS=1000L * 60L * 30L;
  public static long DEFAULT_MAX_EVICTABLE_IDLE_TIME_MILLIS=1000L * 60L * 60L* 7;
  public static long DEFAULT_PHY_TIMEOUT_MILLIS=-1;
  volatile boolean defaultAutoCommit=true;
  volatile Boolean defaultReadOnly;
  volatile Integer defaultTransactionIsolation;
  volatile String defaultCatalog=null;
  String name;
  volatile String username;
  volatile String password;
  volatile String jdbcUrl;
  volatile String driverClass;
  volatile ClassLoader driverClassLoader;
  volatile Properties connectProperties=new Properties();
  volatile PasswordCallback passwordCallback;
  volatile NameCallback userCallback;
  volatile int initialSize=DEFAULT_INITIAL_SIZE;
  volatile int maxActive=DEFAULT_MAX_ACTIVE_SIZE;
  volatile int minIdle=DEFAULT_MIN_IDLE;
  volatile int maxIdle=DEFAULT_MAX_IDLE;
  volatile long maxWait=DEFAULT_MAX_WAIT;
  int notFullTimeoutRetryCount=0;
  volatile String validationQuery=DEFAULT_VALIDATION_QUERY;
  volatile int validationQueryTimeout=-1;
  volatile boolean testOnBorrow=DEFAULT_TEST_ON_BORROW;
  volatile boolean testOnReturn=DEFAULT_TEST_ON_RETURN;
  volatile boolean testWhileIdle=DEFAULT_WHILE_IDLE;
  volatile boolean poolPreparedStatements=false;
  volatile boolean sharePreparedStatements=false;
  volatile int maxPoolPreparedStatementPerConnectionSize=10;
  volatile boolean inited=false;
  volatile boolean initExceptionThrow=true;
  ...
  volatile ExceptionSorter exceptionSorter=null;
  Driver driver;
  volatile int queryTimeout;
  volatile int transactionQueryTimeout;
  long createTimespan;
  volatile int maxWaitThreadCount=-1;
  volatile boolean accessToUnderlyingConnectionAllowed=true;
  volatile long timeBetweenEvictionRunsMillis=DEFAULT_TIME_BETWEEN_EVICTION_RUNS_MILLIS;
  volatile int numTestsPerEvictionRun=DEFAULT_NUM_TESTS_PER_EVICTION_RUN;
  volatile long minEvictableIdleTimeMillis=DEFAULT_MIN_EVICTABLE_IDLE_TIME_MILLIS;
  volatile long maxEvictableIdleTimeMillis=DEFAULT_MAX_EVICTABLE_IDLE_TIME_MILLIS;
  volatile long phyTimeoutMillis=DEFAULT_PHY_TIMEOUT_MILLIS;
  volatile long phyMaxUseCount=-1;
  volatile boolean removeAbandoned;
  volatile long removeAbandonedTimeoutMillis=300 * 1000;
  volatile boolean logAbandoned;
  volatile int maxOpenPreparedStatements=-1;
  volatile List<String> connectionInitSqls;
  volatile String dbType;
  volatile long timeBetweenConnectErrorMillis=DEFAULT_TIME_BETWEEN_CONNECT_ERROR_MILLIS;
  volatile ValidConnectionChecker validConnectionChecker=null;
  ...
  long id;
  int connectionErrorRetryAttempts=1;
  boolean breakAfterAcquireFailure=false;
  long transactionThresholdMillis=0L;
  Date createdTime=new Date();
  Date initedTime;
  volatile long errorCount=0L;
  volatile long dupCloseCount=0L;
  volatile long startTransactionCount=0L;
  volatile long commitCount=0L;
  volatile long rollbackCount=0L;
  volatile long cachedPreparedStatementHitCount=0L;
  volatile long preparedStatementCount=0L;
  volatile long closedPreparedStatementCount=0L;
  volatile long cachedPreparedStatementCount=0L;
  volatile long cachedPreparedStatementDeleteCount=0L;
  volatile long cachedPreparedStatementMissCount=0L;
  static AtomicLongFieldUpdater<DruidAbstractDataSource> errorCountUpdater=AtomicLongFieldUpdater.newUpdater(DruidAbstractDataSource.class,"errorCount");
  static AtomicLongFieldUpdater<DruidAbstractDataSource> dupCloseCountUpdater=AtomicLongFieldUpdater.newUpdater(DruidAbstractDataSource.class,"dupCloseCount");
  static AtomicLongFieldUpdater<DruidAbstractDataSource> startTransactionCountUpdater=AtomicLongFieldUpdater.newUpdater(DruidAbstractDataSource.class,"startTransactionCount");
  static AtomicLongFieldUpdater<DruidAbstractDataSource> commitCountUpdater=AtomicLongFieldUpdater.newUpdater(DruidAbstractDataSource.class,"commitCount");
  static AtomicLongFieldUpdater<DruidAbstractDataSource> rollbackCountUpdater=AtomicLongFieldUpdater.newUpdater(DruidAbstractDataSource.class,"rollbackCount");
  static AtomicLongFieldUpdater<DruidAbstractDataSource> cachedPreparedStatementHitCountUpdater=AtomicLongFieldUpdater.newUpdater(DruidAbstractDataSource.class,"cachedPreparedStatementHitCount");
  static AtomicLongFieldUpdater<DruidAbstractDataSource> preparedStatementCountUpdater=AtomicLongFieldUpdater.newUpdater(DruidAbstractDataSource.class,"preparedStatementCount");
  static AtomicLongFieldUpdater<DruidAbstractDataSource> closedPreparedStatementCountUpdater=AtomicLongFieldUpdater.newUpdater(DruidAbstractDataSource.class,"closedPreparedStatementCount");
  static AtomicLongFieldUpdater<DruidAbstractDataSource> cachedPreparedStatementCountUpdater=AtomicLongFieldUpdater.newUpdater(DruidAbstractDataSource.class,"cachedPreparedStatementCount");
  static AtomicLongFieldUpdater<DruidAbstractDataSource> cachedPreparedStatementDeleteCountUpdater=AtomicLongFieldUpdater.newUpdater(DruidAbstractDataSource.class,"cachedPreparedStatementDeleteCount");
  static AtomicLongFieldUpdater<DruidAbstractDataSource> cachedPreparedStatementMissCountUpdater=AtomicLongFieldUpdater.newUpdater(DruidAbstractDataSource.class,"cachedPreparedStatementMissCount");
  Histogram transactionHistogram=new Histogram(1,10,100,1000,10 * 1000,100 * 1000);
  private boolean dupCloseLogEnable=false;
  private ObjectName objectName;
  volatile long executeCount=0L;
  volatile long executeQueryCount=0L;
  volatile long executeUpdateCount=0L;
  volatile long executeBatchCount=0L;
  static AtomicLongFieldUpdater<DruidAbstractDataSource> executeQueryCountUpdater=AtomicLongFieldUpdater.newUpdater(DruidAbstractDataSource.class,"executeQueryCount");
  static AtomicLongFieldUpdater<DruidAbstractDataSource> executeUpdateCountUpdater=AtomicLongFieldUpdater.newUpdater(DruidAbstractDataSource.class,"executeUpdateCount");
  static AtomicLongFieldUpdater<DruidAbstractDataSource> executeBatchCountUpdater=AtomicLongFieldUpdater.newUpdater(DruidAbstractDataSource.class,"executeBatchCount");
  static AtomicLongFieldUpdater<DruidAbstractDataSource> executeCountUpdater=AtomicLongFieldUpdater.newUpdater(DruidAbstractDataSource.class,"executeCount");
  volatile Throwable createError;
  volatile Throwable lastError;
  volatile long lastErrorTimeMillis;
  volatile Throwable lastCreateError;
  volatile long lastCreateErrorTimeMillis;
  volatile long lastCreateStartTimeMillis;
  boolean isOracle=false;
  boolean isMySql=false;
  boolean useOracleImplicitCache=true;
  ReentrantLock lock;
  Condition notEmpty;
  Condition empty;
  ReentrantLock activeConnectionLock=new ReentrantLock();
  volatile int createErrorCount=0;
  volatile int creatingCount=0;
  volatile int directCreateCount=0;
  volatile long createCount=0L;
  volatile long destroyCount=0L;
  volatile long createStartNanos=0L;
  static AtomicIntegerFieldUpdater<DruidAbstractDataSource> createErrorCountUpdater=AtomicIntegerFieldUpdater.newUpdater(DruidAbstractDataSource.class,"createErrorCount");
  static AtomicIntegerFieldUpdater<DruidAbstractDataSource> creatingCountUpdater=AtomicIntegerFieldUpdater.newUpdater(DruidAbstractDataSource.class,"creatingCount");
  static AtomicIntegerFieldUpdater<DruidAbstractDataSource> directCreateCountUpdater=AtomicIntegerFieldUpdater.newUpdater(DruidAbstractDataSource.class,"directCreateCount");
  static AtomicLongFieldUpdater<DruidAbstractDataSource> createCountUpdater=AtomicLongFieldUpdater.newUpdater(DruidAbstractDataSource.class,"createCount");
  static AtomicLongFieldUpdater<DruidAbstractDataSource> destroyCountUpdater=AtomicLongFieldUpdater.newUpdater(DruidAbstractDataSource.class,"destroyCount");
  static AtomicLongFieldUpdater<DruidAbstractDataSource> createStartNanosUpdater=AtomicLongFieldUpdater.newUpdater(DruidAbstractDataSource.class,"createStartNanos");
  ...
  AtomicBoolean failContinuous=new AtomicBoolean(false);
  ScheduledExecutorService destroyScheduler;
  ScheduledExecutorService createScheduler;
  boolean initVariants=false;
  boolean initGlobalVariants=false;
  volatile boolean onFatalError=false;
  volatile int onFatalErrorMaxActive=0;
  volatile long lastFatalErrorTimeMillis=0;
  volatile String lastFatalErrorSql=null;
  volatile Throwable lastFatalError=null;
  ...
  public long getAndResetExecuteCount(){
    return executeCountUpdater.getAndSet(this,0) + executeQueryCountUpdater.getAndSet(this,0) + executeUpdateCountUpdater.getAndSet(this,0)+ executeBatchCountUpdater.getAndSet(this,0);
  }
 ...
 * @return the current query timeout limit in seconds; zero means there is no limit<code>Statement</code>
 * @see #setQueryTimeout
 */
 ...
 */
  ...
  @Override public List<Filter> getProxyFilters(){
    return filters;
  }
 ...
 */
  ...
  @Override public Driver getRawDriver(){
    return driver;
  }
  ...
  volatile long connectionIdSeed=10000L;
  volatile long statementIdSeed=20000L;
  volatile long resultSetIdSeed=50000L;
  volatile long transactionIdSeed=60000L;
  volatile long metaDataIdSeed=80000L;
  static AtomicLongFieldUpdater<DruidAbstractDataSource> connectionIdSeedUpdater=AtomicLongFieldUpdater.newUpdater(DruidAbstractDataSource.class,"connectionIdSeed");
  static AtomicLongFieldUpdater<DruidAbstractDataSource> statementIdSeedUpdater=AtomicLongFieldUpdater.newUpdater(DruidAbstractDataSource.class,"statementIdSeed");
  static AtomicLongFieldUpdater<DruidAbstractDataSource> resultSetIdSeedUpdater=AtomicLongFieldUpdater.newUpdater(DruidAbstractDataSource.class,"resultSetIdSeed");
  static AtomicLongFieldUpdater<DruidAbstractDataSource> transactionIdSeedUpdater=AtomicLongFieldUpdater.newUpdater(DruidAbstractDataSource.class,"transactionIdSeed");
  static AtomicLongFieldUpdater<DruidAbstractDataSource> metaDataIdSeedUpdater=AtomicLongFieldUpdater.newUpdater(DruidAbstractDataSource.class,"metaDataIdSeed");
  ...
  @Override public long createTransactionId(){
  ...
  public void initPhysicalConnection(  Connection conn,  Map<String,Object> variables,  Map<String,Object> globalVariables) throws SQLException {
    ...
    try {
      ...
      if (JdbcConstants.MYSQL.equals(dbType) || JdbcConstants.ALIYUN_ADS.equals(dbType)) {
        if (variables != null) {
          ResultSet rs=null;
          try {
