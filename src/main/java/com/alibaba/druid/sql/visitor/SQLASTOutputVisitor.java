...
static {
    try {
      defaultPrintStatementAfterSemi=getBoolean(System.getProperties(),"druid.sql.output.printStatementAfterSemi");
    }
 catch (    Throwable ex) {
    }
  }
  ...
  int indentCount=0;
  boolean ucase=true;
  int selectListNumberOfLine=5;
  boolean groupItemSingleLine=false;
  ...
  int replaceCount;
  boolean parameterizedMergeInList=false;
  boolean parameterizedQuesUnMergeInList=false;
  boolean parameterized=false;
  boolean shardingSupport=false;
  transient int lines=0;
  Boolean printStatementAfterSemi=defaultPrintStatementAfterSemi;
{
 ...
 */
 ...
 else         if (lineItemCount >= selectListNumberOfLine || selectItemExpr instanceof SQLQueryExpr || selectItemExpr instanceof SQLCaseExpr) {
          lineItemCount=0;
          println();
        }
        print0(", ");
...
if (operator == SQLBinaryOperator.Modulus && JdbcConstants.ORACLE.equals(dbType) && left instanceof SQLIdentifierExpr && right instanceof SQLIdentifierExpr && ((SQLIdentifierExpr)right).getName().equalsIgnoreCase("NOTFOUND")) {
  printOpSpace=false;
}
if (printOpSpace) {
  print(' ');
...
if (rightOp.priority >= op.priority || (right.isBracket() && rightOp != op && rightOp.isLogical() && op.isLogical())) {
if (rightRational) {
  this.indentCount++;
}
print('(');
...
if (leftOp.priority > op.priority || (binaryLeft.isBracket() && leftOp != op && leftOp.isLogical() && op.isLogical())) {
if (leftRational) {
  this.indentCount++;
}
print('(');
...
if (this.parameterized && x.getParent() instanceof ValuesClause) {
print('?');
incrementReplaceCunt();
if (this.parameters != null) {
...
print(' ');
 ...
 else if (JdbcConstants.DB2.equals(dbType) || JdbcConstants.ORACLE.equals(dbType) || JdbcConstants.SQL_SERVER.equals(dbType)) {
SQLObject parent=x.getParent();
if (parent instanceof SQLSelect) {
...
@Override public boolean visit(SQLColumnDefinition.Identity x){
...
@Override public boolean visit(SQLUnionQuery x){
...
SQLOrderBy orderBy=x.getOrderBy();
if ((!bracket) && left instanceof SQLUnionQuery && ((SQLUnionQuery)left).getOperator() == operator && !right.isBracket() && orderBy == null) {
...
if (orderBy != null && (!right.isBracket()) && right instanceof SQLSelectQueryBlock) {
...
@Override public boolean visit(SQLUnaryExpr x){
...
@Override public boolean visit(SQLCallStatement x){
if (x.isBrace()) {
print('{');
}
...
@Override public boolean visit(SQLJoinTableSource x){
SQLTableSource left=x.getLeft();
if (left instanceof SQLJoinTableSource && ((SQLJoinTableSource)left).getJoinType() == JoinType.COMMA && x.getJoinType() != JoinType.COMMA && !JdbcConstants.POSTGRESQL.equals(dbType)) {
print('(');
...
@Override public boolean visit(ValuesClause x){
...
@Override public boolean visit(SQLListExpr x){
print('(');
printAndAccept(x.getItems(),", ");
print(')');
return false;
...
@Override public boolean visit(SQLTruncateStatement x){
...
@Override public boolean visit(SQLDefaultExpr x){
print0(ucase ? "DEFAULT" : "default");
return false;
}
@Override public void endVisit(SQLCommentStatement x){
}
...
@Override public boolean visit(SQLUseStatement x){
...
@Override public void endVisit(SQLAlterTableAddColumn x){
}
@Override public boolean visit(SQLDropIndexStatement x){
...
@Override public boolean visit(SQLDropLogFileGroupStatement x){
print0(ucase ? "DROP LOGFILE GROUP " : "drop logfile group ");
x.getName().accept(this);
return false;
}
@Override public boolean visit(SQLDropServerStatement x){
...
@Override public boolean visit(SQLDropTypeStatement x){
...
@Override public boolean visit(SQLDropSynonymStatement x){
if (x.isPublic()) {
...
@Override public boolean visit(SQLCreateDatabaseStatement x){
...
@Override public boolean visit(SQLAlterViewStatement x){
...
@Override public boolean visit(SQLCreateViewStatement x){
print0(ucase ? "CREATE " : "create ");
if (x.isOrReplace()) {
...
@Override public boolean visit(SQLAlterTableDropIndex x){
print0(ucase ? "DROP INDEX " : "drop index ");
x.getIndexName().accept(this);
return false;
}
@Override public boolean visit(SQLOver x){
...
@Override public boolean visit(SQLKeep x){
...
@Override public boolean visit(SQLColumnPrimaryKey x){
if (x.getName() != null) {
print0(ucase ? "CONSTRAINT " : "constraint ");
x.getName().accept(this);
print(' ');
...
@Override public boolean visit(SQLColumnUniqueKey x){
if (x.getName() != null) {
print0(ucase ? "CONSTRAINT " : "constraint ");
x.getName().accept(this);
print(' ');
...
@Override public boolean visit(SQLColumnCheck x){
if (x.getName() != null) {
print0(ucase ? "CONSTRAINT " : "constraint ");
x.getName().accept(this);
print(' ');
...
@Override public boolean visit(SQLWithSubqueryClause x){
print0(ucase ? "WITH " : "with ");
...
@Override public boolean visit(SQLWithSubqueryClause.Entry x){
print0(x.getAlias());
if (x.getColumns().size() > 0) {
print0(" (");
printAndAccept(x.getColumns(),", ");
...
@Override public boolean visit(SQLAlterTableAlterColumn x){
boolean odps=isOdps();
if (odps) {
...
@Override public boolean visit(SQLCheck x){
if (x.getName() != null) {
print0(ucase ? "CONSTRAINT " : "constraint ");
x.getName().accept(this);
print(' ');
...
@Override public boolean visit(SQLAlterTableDropForeignKey x){
print0(ucase ? "DROP FOREIGN KEY " : "drop foreign key ");
x.getIndexName().accept(this);
return false;
}
@Override public boolean visit(SQLAlterTableDropPrimaryKey x){
print0(ucase ? "DROP PRIMARY KEY" : "drop primary key");
return false;
}
@Override public boolean visit(SQLAlterTableDropKey x){
print0(ucase ? "DROP KEY " : "drop key ");
x.getKeyName().accept(this);
return false;
}
@Override public boolean visit(SQLAlterTableEnableKeys x){
print0(ucase ? "ENABLE KEYS" : "enable keys");
return false;
}
@Override public boolean visit(SQLAlterTableDisableKeys x){
...
@Override public boolean visit(SQLAlterTableDropConstraint x){
...
@Override public boolean visit(SQLExprHint x){
x.getExpr().accept(this);
return false;
}
@Override public boolean visit(SQLCreateIndexStatement x){
print0(ucase ? "CREATE " : "create ");
if (x.getType() != null) {
print0(x.getType());
print(' ');
...
@Override public boolean visit(SQLUnique x){
SQLName name=x.getName();
if (name != null) {
print0(ucase ? "CONSTRAINT " : "constraint ");
name.accept(this);
...
@Override public boolean visit(SQLPrimaryKeyImpl x){
SQLName name=x.getName();
if (name != null) {
print0(ucase ? "CONSTRAINT " : "constraint ");
name.accept(this);
...
@Override public boolean visit(SQLAlterTableRenameColumn x){
...
@Override public boolean visit(SQLColumnReference x){
SQLName name=x.getName();
if (name != null) {
print0(ucase ? "CONSTRAINT " : "constraint ");
name.accept(this);
...
@Override public boolean visit(SQLForeignKeyImpl x){
if (x.getName() != null) {
print0(ucase ? "CONSTRAINT " : "constraint ");
x.getName().accept(this);
print(' ');
...
@Override public boolean visit(SQLDropSequenceStatement x){
...
@Override public void endVisit(SQLDropSequenceStatement x){
}
@Override public boolean visit(SQLDropTriggerStatement x){
...
@Override public void endVisit(SQLDropUserStatement x){
}
@Override public boolean visit(SQLDropUserStatement x){
print0(ucase ? "DROP USER " : "drop user ");
printAndAccept(x.getUsers(),", ");
return false;
}
@Override public boolean visit(SQLExplainStatement x){
...
@Override public boolean visit(SQLGrantStatement x){
...
@Override public boolean visit(SQLRevokeStatement x){
...
@Override public boolean visit(SQLDropDatabaseStatement x){
...
@Override public boolean visit(SQLDropFunctionStatement x){
...
@Override public boolean visit(SQLDropTableSpaceStatement x){
...
@Override public boolean visit(SQLDropProcedureStatement x){
...
@Override public boolean visit(SQLAlterTableAddIndex x){
print0(ucase ? "ADD " : "add ");
...
@Override public boolean visit(SQLAlterTableAddConstraint x){
if (x.isWithNoCheck()) {
...
@Override public boolean visit(SQLUnionQueryTableSource x){
print('(');
this.indentCount++;
println();
...
@Override public boolean visit(SQLTimestampExpr x){
if (this.parameterized) {
print('?');
incrementReplaceCunt();
if (this.parameters != null) {
...
@Override public boolean visit(SQLBinaryExpr x){
print0("b'");
print0(x.getText());
print('\'');
return false;
}
@Override public boolean visit(SQLAlterTableRename x){
...
@Override public boolean visit(SQLAlterViewRenameStatement x){
...
@Override public boolean visit(SQLAlterTableAddPartition x){
print0(ucase ? "ADD " : "add ");
if (x.isIfNotExists()) {
print0(ucase ? "IF NOT EXISTS " : "if not exists ");
}
...
@Override public boolean visit(SQLAlterTableReOrganizePartition x){
...
@Override public boolean visit(SQLAlterTableDropPartition x){
print0(ucase ? "DROP " : "drop ");
if (x.isIfExists()) {
print0(ucase ? "IF EXISTS " : "if exists ");
}
...
@Override public boolean visit(SQLAlterTableRenamePartition x){
print0(ucase ? "PARTITION (" : "partition (");
...
@Override public boolean visit(SQLAlterTableSetComment x){
print0(ucase ? "SET COMMENT " : "set comment ");
x.getComment().accept(this);
return false;
}
@Override public boolean visit(SQLAlterTableSetLifecycle x){
print0(ucase ? "SET LIFECYCLE " : "set lifecycle ");
x.getLifecycle().accept(this);
return false;
}
@Override public boolean visit(SQLAlterTableEnableLifecycle x){
...
@Override public boolean visit(SQLAlterTableDisableLifecycle x){
if (x.getPartition().size() != 0) {
print0(ucase ? "PARTITION (" : "partition (");
printAndAccept(x.getPartition(),", ");
print0(") ");
...
@Override public boolean visit(SQLAlterTableTouch x){
...
@Override public boolean visit(SQLArrayExpr x){
x.getExpr().accept(this);
print('[');
...
@Override public boolean visit(SQLOpenStatement x){
...
@Override public boolean visit(SQLFetchStatement x){
...
@Override public boolean visit(SQLCloseStatement x){
print0(ucase ? "CLOSE " : "close ");
printExpr(x.getCursorName());
return false;
}
@Override public boolean visit(SQLGroupingSetExpr x){
...
@Override public boolean visit(SQLParameter x){
SQLName name=x.getName();
...
if (JdbcConstants.ORACLE.equals(dbType) || dataType instanceof OracleFunctionDataType || dataType instanceof OracleProcedureDataType) {
...
if (x.getParamType() == SQLParameter.ParameterType.IN) {
boolean skip=JdbcConstants.MYSQL.equals(dbType) && x.getParent() instanceof SQLCreateFunctionStatement;
if (!skip) {
print0(ucase ? "IN " : "in ");
}
}
...
@Override public boolean visit(SQLDeclareItem x){
SQLDataType dataType=x.getDataType();
...
@Override public boolean visit(SQLPartitionValue x){
if (x.getOperator() == SQLPartitionValue.Operator.LessThan && (!JdbcConstants.ORACLE.equals(getDbType())) && x.getItems().size() == 1 && x.getItems().get(0) instanceof SQLIdentifierExpr) {
...
@Override public boolean visit(SQLPartition x){
print0(ucase ? "PARTITION " : "partition ");
x.getName().accept(this);
if (x.getValues() != null) {
print(' ');
...
@Override public boolean visit(SQLPartitionByRange x){
print0(ucase ? "RANGE" : "range");
...
@Override public boolean visit(SQLPartitionByList x){
...
@Override public boolean visit(SQLPartitionByHash x){
if (x.isLinear()) {
...
@Override public boolean visit(SQLSubPartitionByHash x){
if (x.isLinear()) {
...
@Override public boolean visit(SQLSubPartitionByList x){
if (x.isLinear()) {
print0(ucase ? "SUBPARTITION BY LINEAR HASH " : "subpartition by linear hash ");
}
 else {
...
@Override public boolean visit(SQLSubPartition x){
...
@Override public boolean visit(SQLAlterDatabaseStatement x){
...
@Override public boolean visit(SQLAlterTableConvertCharSet x){
...
@Override public boolean visit(SQLAlterTableCoalescePartition x){
print0(ucase ? "COALESCE PARTITION " : "coalesce partition ");
x.getCount().accept(this);
return false;
}
@Override public boolean visit(SQLAlterTableTruncatePartition x){
print0(ucase ? "TRUNCATE PARTITION " : "truncate partition ");
printPartitions(x.getPartitions());
return false;
}
@Override public boolean visit(SQLAlterTableDiscardPartition x){
...
@Override public boolean visit(SQLAlterTableImportPartition x){
print0(ucase ? "IMPORT PARTITION " : "import partition ");
printPartitions(x.getPartitions());
return false;
}
@Override public boolean visit(SQLAlterTableAnalyzePartition x){
...
@Override public boolean visit(SQLAlterTableCheckPartition x){
print0(ucase ? "CHECK PARTITION " : "check partition ");
printPartitions(x.getPartitions());
return false;
}
@Override public boolean visit(SQLAlterTableOptimizePartition x){
print0(ucase ? "OPTIMIZE PARTITION " : "optimize partition ");
printPartitions(x.getPartitions());
return false;
}
@Override public boolean visit(SQLAlterTableRebuildPartition x){
print0(ucase ? "REBUILD PARTITION " : "rebuild partition ");
printPartitions(x.getPartitions());
return false;
}
@Override public boolean visit(SQLAlterTableRepairPartition x){
print0(ucase ? "REPAIR PARTITION " : "repair partition ");
printPartitions(x.getPartitions());
return false;
}
@Override public boolean visit(SQLSequenceExpr x){
x.getSequence().accept(this);
print('.');
print0(ucase ? x.getFunction().name : x.getFunction().name_lcase);
return false;
}
@Override public boolean visit(SQLMergeStatement x){
...
@Override public boolean visit(MergeUpdateClause x){
...
@Override public boolean visit(MergeInsertClause x){
...
@Override public boolean visit(SQLErrorLoggingClause x){
...
@Override public boolean visit(SQLCreateSequenceStatement x){
...
@Override public boolean visit(SQLAlterSequenceStatement x){
...
@Override public boolean visit(SQLWhileStatement x){
...
@Override public boolean visit(SQLDeclareStatement x){
...
@Override public boolean visit(SQLReturnStatement x){
print0(ucase ? "RETURN" : "return");
if (x.getExpr() != null) {
print(' ');
x.getExpr().accept(this);
...
@Override public boolean visit(SQLArgument x){
...
@Override public boolean visit(SQLCommitStatement x){
...
@Override public boolean visit(SQLIntervalExpr x){
print0(ucase ? "INTERVAL " : "interval ");
...
@Override public boolean visit(SQLLateralViewTableSource x){
x.getTableSource().accept(this);
this.indentCount++;
println();
...
@Override public boolean visit(SQLShowErrorsStatement x){
print0(ucase ? "SHOW ERRORS" : "show errors");
return true;
}
@Override public boolean visit(SQLAlterCharacter x){
print0(ucase ? "CHARACTER SET = " : "character set = ");
...
@Override public boolean visit(SQLRecordDataType x){
...
@Override public boolean visit(SQLExprStatement x){
x.getExpr().accept(this);
return false;
}
...
@Override public boolean visit(SQLArrayDataType x){
print0(ucase ? "ARRAY<" : "array<");
x.getComponentType().accept(this);
print('>');
return false;
}
@Override public boolean visit(SQLMapDataType x){
...
@Override public boolean visit(SQLStructDataType x){
print0(ucase ? "STRUCT<" : "struct<");
printAndAccept(x.getFields(),", ");
print('>');
return false;
}
@Override public boolean visit(SQLStructDataType.Field x){
x.getName().accept(this);
print(':');
x.getDataType().accept(this);
print('>');
...
@Override public boolean visit(SQLAlterTableExchangePartition x){
...
@Override public boolean visit(SQLValuesExpr x){
print0(ucase ? "VALUES (" : "values (");
printAndAccept(x.getValues(),", ");
return false;
}
@Override public boolean visit(SQLValuesTableSource x){
List<SQLName> columns=x.getColumns();
if (columns.size() > 0) {
print('(');
}
...
@Override public boolean visit(SQLWindow x){
x.getName().accept(this);
print0(ucase ? " AS " : " as ");
x.getOver().accept(this);
return false;
}
@Override public boolean visit(SQLDumpStatement x){
